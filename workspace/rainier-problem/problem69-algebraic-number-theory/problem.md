...
This problem is classified under Number Theory and Algebraic number theory because it asks for ramification and discriminant invariants of an elementary abelian Kummer extension of a cyclotomic local field. The decisive structure is the filtration of Kummer classes by valuation and higher-unit depth, followed by the conversion from upper to lower ramification and the discriminant calculation in a tower of local fields.